...
<body>
            ...
            <form id="patientRegisterForm">
                ...
                <div class=" gender-selection">
                    ...
                    <div class="radio-inline">
                        <label><input type="radio" name="patientGender" value="male" required> 남성</label>
                        <label><input type="radio" name="patientGender" value="female" required> 여성</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="patientPhone">전화번호:</label>
                    <input type="tel" id="patientPhone" name="patientPhone" maxlength="13" required>
                </div>
                <div class="form-group">
                    <label for="patientAddress">주소:</label>
                    <!-- <input type="text" id="patientAddress" name="patientAddress"> -->
                    <div class="form-group">
                        <!-- <label for="patientPostcode">우편번호:</label> -->
                        <input type="text" id="patientPostcode" name="patientPostcode" placeholder="우편번호" readonly
                            required>
                        <button type="button" onclick="execDaumPostcode()">우편번호 찾기</button>
                    </div>
                    <div class="form-group">
                        <!-- <label for="patientAddress">주소:</label> -->
                        <input type="text" id="patientAddress" name="patientAddress" placeholder="주소" readonly required>
                    </div>
                    <div class="form-group">
                        <!-- <label for="patientDetailAddress">상세주소:</label> -->
                        <input type="text" id="patientDetailAddress" name="patientDetailAddress" placeholder="상세주소"
                            required>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        //             console.log("설정할 우편번호:", data.zonecode);
        ...
        //             console.log("우편번호 필드 값:", document.getElementById('patientPostcode').value);
        //             console.log("주소 필드 값:", document.getElementById('patientAddress').value);
        //         }
        //     }).open();
        // }
...
전화번호(ver3 완료)
숫자만 입력하면 자동으로 - -까지 표시해서 13자리로 보이게 포맷설정, 저장은 숫자만
