...
import com.emr.www.repository.doctor.api.DrugRepository;
...
public class DrugService extends AbstractApiService<DrugDTO> {
	...
	private final DrugRepository drugRepository;
	 ...
	 public DrugService(@Value("${api.key}") String apiKey, @Value("${api.drug.url}") String apiBaseUrl, DrugRepository drugRepository) {
