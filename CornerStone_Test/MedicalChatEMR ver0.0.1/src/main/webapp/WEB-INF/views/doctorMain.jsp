...
<body>
	...
	<script>
		...
		/*API 데이터 DB에 저장*/
		function saveData() {
			const diagnosisData = collectTableData('#diagnosis tbody');
			const prescriptionData = collectTableData('#prescriptions tbody');
			const drugData = collectTableData('#drugPrescriptions tbody');
			...
			$.ajax({
				...
				error : function(xhr, status, error) {
					...
					alert("저장 중 오류가 발생했습니다. 서버 로그를 확인하세요.");
				}
			});
		}
