...
<body>
			...
			<section class="patient-details card">
				...
				<div class="section">
					...
					<table id="recordTable">
						...
						<tr class="record" data-details="증상: 두통 | 혈압: 120/80 | 체온: 36.5 | 질병명: 편두통 | 처방: 아스피린, 500mg x 2회 x 3일">
							<td class="table-cell">2024-01-01</td>
							<td class="table-cell">편두통</td>
							<td class="table-cell">아스피린</td>
							<td class="table-cell">홍길동</td>
						</tr>
						<tr class="record" data-details="증상: 기침 | 혈압: 125/85 | 체온: 37.2 | 질병명: 감기 | 처방: 타이레놀, 500mg x 2회 x 5일">
							<td class="table-cell">2024-01-15</td>
							<td class="table-cell">감기</td>
							<td class="table-cell">타이레놀</td>
							<td class="table-cell">김철수</td>
						</tr>
					</table>
	...
	<script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            // 이벤트 위임 방식으로 진료 기록 클릭 처리
            document.getElementById('recordTable').addEventListener('click', function (event) {
                const target = event.target.closest('.record');
                if (target) {
                    const detailsContent = target.dataset.details;
