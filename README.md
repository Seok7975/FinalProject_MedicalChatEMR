...
<br><br><br><br>
 <b>* 최종 결과물은 최종 프로젝트 발표 자료를 참고 해주세요.<br> 용량 문제로 인해 dicom file,스크린샷,ppt 파일들은 부득이하게 올리지 못 했습니다.<br>또한 프로젝트를 정상적으로 작동 시키기 위해서 따로 key 발급을 받아야 합니다. *</b>
<br><br><br><br>
## 1. 프로젝트 개요
...
| 이름 | 역할 |
|------|------|
| 박홍석 | 조장, DB 관련, API 연동, 수간호사 UI 및 백 로직 구축, Chat GPT 연동  |
| 임준혁 | DB 관련, 팍스,다이콤 연동 |
...
- **정민석**: Spring Boot 학습, 로그인/회원가입 페이지 구현
- **정현지**: Spring Boot 설정 및 학습, DB v4 업데이트, 병원장 기능 수정
